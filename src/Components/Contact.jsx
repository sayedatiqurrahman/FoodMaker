            ...
            <div className=" w-full">
                ...
                <form className='text-center'>
                    <div className='flex flex-col gap-4'>
                        ...
                        <input required className='h-10 bg-transparent border border-gray-500 rounded-full' type="text" placeholder='Enter Your Name' />


                        <input required className='h-10 bg-transparent border border-gray-500 rounded-full' type="email" placeholder='Enter Your Email' />
                        <textarea required className=' bg-transparent
border-b-2 
border-gray-500  rounded-lg' type="email" placeholder='Enter Your Message' rows={5} />
                    </div>
                    <button className='drop-shadow-md transition-all duration-200 border-2 border-yellow-400 px-20 rounded-full text-lg font-bold py-2 mt-4 bg-yellow-700 hover:bg-yellow-400 hover:text-black ' type="submit">Submit </button>
                </form>
            </div>
            {/* Map Ifaram */}
            <div className="w-full">
